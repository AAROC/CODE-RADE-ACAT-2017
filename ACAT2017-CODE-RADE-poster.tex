...
% todo and next features
     ...
     \begin{columns}%blocks will be placed into columns
         ...
         \block[roundedcorners=40]{Introduction}{
             \textcolor{red}{\textbf C}ontinuous \textcolor{red}{\textbf I}ntegration and \textcolor{red}{\textbf D}elivery of \textcolor{red}{\textbf R}esearch \textcolor{red}{\textbf A}pplications in a \textcolor{red}{\textbf D}istributed \textcolor{red}{\textbf E}nvironment (CODE-RADE).
