...
% Commands
 ...
 \author{
     \begin{tabular}{cc}
         ...
         smurray@csir.co.za & bbecker@csir.co.za
     \end{tabular}
}
\institute{CSIR, Meraka. Center for Hight Performance Computing.  University of Cape Town}
\titlegraphic{
     ...
     \begin{columns}%blocks will be placed into columns
         ...
         \block[roundedcorners=40]{The problem CODE-RADE solves}{
             \center{The researcher is faced with a paradox.}\\
               ...
               %      \end{tikzfigure}
               %   \end{wrapfigure}
                     There is a huge amount of computing resources available, and a rich, well maintained, interoperable infrstructure of services \textbf{however} \\
             Getting applictions onto it requires far too much effort.
         }         
         \block[roundedcorners=40]{CODE-RADE solves this by }{
                  Lowering the barrier to entry to grid or cloud infrastructure, or single HPC site. 
                  ...
                  Easily manages the lifecycle of applications across multiple versions, architectures and configurations \\
                  Ensures that once an application is certified, its available on as many sites as possible. \\
                  Promotes collaboration between researcher, research software engineer, and infrastructure provider. \\
                  A DOI is automatically created for a successfully tested git hash and deployment with pull requests as authors. \\
%             \begin{itemize}
...
%             \end{itemize}
%         }
         \note[targetoffsetx=30cm,targetoffsety=12.5cm,innersep=.4cm]{DOI via Zenodo}%,angle=-45,connection]{DOI via Zenodo}
         \block[roundedcorners=40]{CODE-RADE is }{
%             \begin{itemize}
                 \textbf{Cross platform} : It builds and test artifacts for an arbitrary set of targets, promoting diversity in computing platforms and ensures proper optimisations and application portability \\
                 \textbf{Atomic} :
...
%             \end{itemize}
         ...
         \block[roundedcorners=40]{Technology}{
             \begin{itemize}
                 \item All builds are inside docker containers so a user could reproduce the constant integration environment locally to test themselves
                 \item All docker images are publicly available at quay.io/ARROC
                 \item releases get a doi, authors are submitters and PR
                     \item build scripts reside at github.com/SouthAfricaDigitalScience
             \end{itemize}
        }
         \column{0.25}
         \block[roundedcorners=40]{CODE-RADE Actors}{

         }

         \block[roundedcorners=40]{Workflow}{
           \center\includegraphics[scale=0.75]{img/code-rade-jenkins-magic.png}
         }
...
/cvmfs/code-rade.africa-grid.org/generic/centos7/x86\_64/gcc/6.3.0
 ...
 %            \subcolumn{0.5}
         ...
         \block[roundedcorners=40]{Where can all this can run}{
             ...
             else prepared to mount the cvmfs repository.
             \center{\includegraphics[scale=0.5]{img/SANReN_2016.png}
             \includegraphics[scale=0.4]{img/africa-working.png}}
         }
...
%         }
         ...
         \block[roundedcorners=40]{Summary}{
             We have built a cross-platform, automated system for integration and delivery of applications that :
             \begin{itemize}
                 \item Deliver functional, tested, reproducible software to your site
                     ...
                     \item Can recognise and reward the work of research software engineers.
             \end{itemize}
        }
     \end{columns}
    \begin{columns}
   ...
   \raisebox{0cm}{\includegraphics[scale=0.15]{img/UFSLogo.jpg}}
%    \raisebox{0cm}{\includegraphics[scale=1.5]{img/coderade.png}}
    \raisebox{-1cm}{\includegraphics[scale=0.25]{img/CSIRlogo.jpg}}
    \raisebox{0cm}{\includegraphics[scale=0.2]{img/SANCG_logoTransparent-cropped.png}}
    \raisebox{0cm}{\includegraphics[scale=0.15]{img/chpclogo.png}}
    \raisebox{0cm}{\includegraphics[scale=1]{img/magrid.png}}
    \raisebox{0cm}{\includegraphics[scale=1]{img/arn.png}}
    \raisebox{0cm}{\includegraphics[scale=1]{img/zc.png}}
 ...
 %  \begin{flushright}\includegraphics[scale=0.25]{img/SANCG_logoTransparent-cropped.png}\end{flushright}
     ...
     \block[roundedcorners=40]{Further Information}{\vspace{2em}
        \textcolor{blue}{github.com/AAROC/CODE-RADE}\\
        \textcolor{blue}{www.africa-grid.org/CODE-RADE}\\
        \textcolor{blue}{www.africa-grid.org/cvmfs}\\
        \textcolor{blue}{www.africa-grid.org/applications}\\
        }
    \end{columns}
 \end{document}
