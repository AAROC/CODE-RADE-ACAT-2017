...
% todo and next features
     ...
     \begin{columns}%blocks will be placed into columns
        ...
        % \note[targetoffsetx=30cm,targetoffsety=12.5cm,innersep=.4cm]{After review, DOI is issued via Zenodo}%,angle=-45,connection]{DOI via Zenodo}
         ...
         We glue together a 1. glue together github, slack, jenkins , jarvis and make it publicly available to the users.
         2. build failure trigger
             \begin{itemize}
                 ...
                 \item All docker images are publicly available at quay.io/AAROC
             ...
             \begin{itemize}
                     \item Components
                           \begin{itemize}
                               ...
                               \item if build fails, issue generated in github.
                               \item Numerous bots to tie the pieces together.
                           \end{itemize}
                     \item Workflow 
                         \begin{itemize}
...
%         \subcolumn{0.5}
         \block[roundedcorners=40]{Architecture}{
             We build the full stack assuming nothing but the base operating system, similar to many hpc sites. We are therefore not dependent on anything local but an operational operating system.
             \begin{itemize}
...
% todo and next features
     ...
     %\begin{columns}%blocks will be placed into columns
         ...
         \block[roundedcorners=40]{Repositories}{
             ...
             \begin{itemize}
                 \item gcc 4.9 5.3 6.3
                 \item geant4 9.6 10.1 10.3
                 \item root 5.34 6.08 6.10
                 \item Fermionic Molecular Dynamics
                 \item  
             \end{itemize}
             The full listing is availabe of ci.sagrid.ac.za or www.africa-grid.org
        }
...
%         }
   ...
   \raisebox{30cm}{\includegraphics[scale=0.15]{img/UFSLogo.jpg}}
%    \raisebox{0cm}{\includegraphics[scale=1.5]{img/coderade.png}}
    \raisebox{30cm}{\includegraphics[scale=0.2]{img/CSIRlogo.jpg}}
    \raisebox{30cm}{\includegraphics[scale=0.1]{img/SANCG_logoTransparent-cropped.png}}
    \raisebox{30cm}{\includegraphics[scale=0.1]{img/chpclogo.png}}
    \raisebox{30cm}{\includegraphics[scale=1.2]{img/magrid.png}}
    \raisebox{30cm}{\includegraphics[scale=1.2]{img/arn.png}}
    \raisebox{30cm}{\includegraphics[scale=1.2]{img/zc.png}}
...
%   \center Feedback and discussion at discourse.sci-gaia.eu
 %  \begin{flushright}\includegraphics[scale=0.25]{img/SANCG_logoTransparent-cropped.png}\end{flushright}
     ...
     \block[roundedcorners=40]{Further Information}{\vspace{2em}
        ...
        \textcolor{blue}{\textbf{www.africa-grid.org/CODE-RADE}}\\
        }
    \end{columns}
 \end{document}
